                    ...
                    <div class="col-md-8">
                        ...
                        <form id="login-form" class="form" action="login-servlet" method="post">
                            ...
                            <div class="d-flex mb-1 align-items-center">
                                <label for="remember-me" class="text-info"><span>Beni Hatırla</span> <span>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="pass_send_btn" name="pass_send_btn" type="button" class="btn btn-primary">Şifre Hatırlat</button>
            </div>
        </div>
    </div>
</div>
