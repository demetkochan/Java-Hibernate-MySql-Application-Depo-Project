        ...
        <div class="col-sm-3">
          <form id="search_form">
            <div class="input-group flex-nowrap">
              ...
              <a onclick="customerSearch()" class="btn btn-outline-primary">Ara</a>
            </div>
          </form>
        </div>
...
<script>
  ...
  function customerSearch(){
    var customerSearchText = document.getElementById('csearch').value;
    if(customerSearchText.length == 0){
      alert("Herhangi bir Değer Yazınız")
    }
    else{
      $.ajax({
        url: './customer-search?name='+customerSearchText,
        type: 'GET',
        dataType: 'Json',
